				...
				<section className="font-inter pb-10">
					<div className="flex items-center justify-between">
						...
						<div className="items-stretch flex gap-3">
							...
							<button className="bg-secondary_dark rounded-full text-white text-[14px] font-medium px-6 leading-[100%] hover:opacity-70">
								Добавить товар
							</button>
						</div>
					</div>
								...
								<tr className="border-t border-[#E5E5E5]">
									...
									<td>
										<div className="text-center">
											<button className="text-white px-5 py-1.5 bg-secondary_dark font-semibold text-[12px] leading-[20px] hover:opacity-80 rounded-full">
												Открыть описание
											</button>
										</div>
									</td>
