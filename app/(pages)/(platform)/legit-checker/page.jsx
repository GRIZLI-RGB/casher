...
export default function LegitCheckerPage() {
	...
	return (
		<section className="py-[110px] px-6 flex-middle flex-col font-gotham max-w-[1115px] mx-auto">
			<h1 className="px-[38px] py-2.5 font-bold text-[32px] text-white bg-dark rounded-[9px]">LEGIT CHECKER</h1>
			<div className="mt-11 mb-6 gap-10 grid grid-cols-2 h-[60px] w-full">
				<input
					className={`rounded-[9px] border-2 font-bold text-[24px] text-center uppercase placeholder:text-dark ${
						status === "error"
				...
				/>
				<button
					className="rounded-[9px] bg-dark uppercase font-bold text-[24px] text-white hover:bg-secondary_dark"
					onClick={() => setStatus("error")}>
					Проверить
				</button>
			</div>
			<div className="uppercase font-bold text-[18px] text-center text-[#808080] leading-[125%]">
				<p className="mb-2.5">
