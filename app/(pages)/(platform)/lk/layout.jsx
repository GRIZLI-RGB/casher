...
export default function LkLayout({ children }) {
	...
	return (
		<div className="flex items-start gap-10 py-20 px-[30px] max-w-[1740px] mx-auto lg:flex-col lg:p-6">
			<div className="w-[405px] lg:w-full">
				<div className="border-2 border-dark rounded-[4px] flex gap-4 p-2 lg:p-1.5">
					<img className="block w-20 h-20 rounded-[4px] lg:w-[60px] lg:h-[60px]" src="/img/avatar.png" alt="Аватар пользователя" />
				...
				<nav className="mt-8 flex flex-col gap-3 min-w-[242px]">
					{[
			...
			<div className="grow lg:w-full">{children}</div>
		</div>
	);
}
