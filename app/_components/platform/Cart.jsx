	...
	if (open) {
		return (
			<div className="absolute top-0 left-0 bottom-0 right-0 bg-dark/25 z-[999]">
				<div className="bg-white w-[692px] ml-auto h-full px-[45px] py-10">
					<div className="flex items-center justify-between mb-6">
						<h2 className="text-[#121212] font-halvar font-medium text-[28px] leading-[29px]">Ваш заказ</h2>
						<img
					...
					<div className="border-y border-[#121212]/20">
						{[...new Array(3)].map((_, index) => (
							<div
								className={`py-6 flex items-center justify-between text-[#121212] ${
								...
								<div className="h-7 w-[83px] flex items-center justify-between rounded-full bg-[#121212] px-2.5">
									...
									<span className="font-halvar font-medium leading-[14px] text-white">1</span>
					...
					<button className="py-4 font-halvar font-medium text-[24px] leading-[22px] uppercase bg-[#121212] text-center w-full rounded-[4px] text-white hover:opacity-90">
						Оформить заказ
					</button>
				</div>
			</div>
